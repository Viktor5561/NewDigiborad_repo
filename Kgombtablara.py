...
def show_right_click_menu(event):
    ...
    right_click_menu.add_separator()
    right_click_menu.add_command(label="Második sor", command=lambda: second_row(event), **bold_font_options)
    right_click_menu.add_separator()
    right_click_menu.add_command(label="Harmadik sor", command=lambda: third_row(event), **bold_font_options)
    right_click_menu.add_separator()
    right_click_menu.add_command(label="Negyedik sor", command=lambda: fourth_row(event), **bold_font_options)
    right_click_menu.add_separator()
    right_click_menu.add_command(label="Ötödik sor", command=lambda: fifth_row(event), **bold_font_options)
    try:
